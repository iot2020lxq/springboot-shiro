...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        //用户密码MD5加密
        SimpleHash md5Password = new SimpleHash("MD5", user.getPassword(), salt, 1);

        System.out.println("MD5："+md5Password);

        System.out.println("RealmName："+getName());

        SimpleAuthenticationInfo info = new SimpleAuthenticationInfo(user, md5Password, salt,getName());
        return info;
